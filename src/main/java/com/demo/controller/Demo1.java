...
public class Demo1 {
    ...
    public String start() {
         ...
         *  xml中定义的ID
         */
        String instanceKey = "my_process";
        logger.info("开启请假流程...");

//        DeploymentBuilder deployment = repositoryService.createDeployment();
//        deployment.addClasspathResource("processes/my_process.bpmn");
//        deployment.deploy();
...
//        deploy.getId();
        ...
        ProcessDefinitionQuery my_process = processDefinitionQuery.processDefinitionKey("my_process");
        long count = my_process.count();
...
//        return String.valueOf(count);
    ...
    public void showImg(@PathVariable String instanceId, HttpServletResponse response) {
        /*
         * 参数校验
         */
        logger.info("查看完整流程图！流程实例ID:{}", instanceId);
        if ((instanceId.trim()).equals("")) return;
    ...
    public String toHigherAudit(String taskId, HttpServletRequest request) {
        ...
        if ((taskId.trim()).equals("")) return "/higherAudit";
    ...
    public String viewTaskManager(String taskId, HttpServletRequest request) {
         ...
         */
        logger.info("跳转到任务详情页面，任务ID:{}", taskId);
        if ((taskId.trim()).equals("")) return "/manageAudit";
    ...
    public String higherLevelAudit(HttpServletRequest request) {
        ...
        if ((taskId.trim()).equals("")) return "fail";
